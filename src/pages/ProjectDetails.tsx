...
const projectData = {
  ...
  description:
    "Protecting 500,000 hectares of primary rainforest in the Amazon basin, preserving biodiversity and indigenous communities. This project works directly with local communities to prevent deforestation while creating sustainable economic opportunities.",
            ...
            <div className="lg:sticky lg:top-28 lg:h-fit">
              <div className="glass-card rounded-2xl p-6 space-y-6 glow-green-subtle">
                ...
                <p className="text-xs text-center text-muted-foreground">
                  Retiring carbon credits permanently removes them from
                  circulation, ensuring they cannot be traded again.
                </p>
              </div>
            </div>
          </div>
